    ...
    fetch(url, option)
      ...
      .then((data) => {
        if (isLogin) {
          ...
          navigate(data.redirect); // Redirect to dashboard or homepage after login
        } else {
      ...
      <div className="auth-container">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          {isLogin && (
            <div className="security-notice">
              ...
              <p>
                <strong>We take privacy seriously.</strong>
              </p>
            </div>
          )}
        </form>
        ...
        <div className="auth-extra">
          ...
          <div className="auth-reminder">
            <p>
              New here? Creating an account is easy and takes less than a
              minute.
            </p>
          </div>
        </div>
